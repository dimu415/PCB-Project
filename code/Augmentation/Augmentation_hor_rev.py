        ...
        for img_filename in defect_list:
            ...
            if self.transform:
                ...
                with open(flipped_label_path, 'w') as label_file:
                    for obj in bndboxes:
                        flipped_xmin = size[0] - obj['xmax']
                        flipped_xmax = size[0] - obj['xmin']
                        flipped_ymin = obj['ymin']
                        flipped_ymax = obj['ymax']
...
flipped_image_folder = 'C:/work/python/PCB/PCB_DATASET/images/Rescaled_images2/i/'
flipped_label_folder = 'C:/work/python/PCB/PCB_DATASET/images/Rescaled_images2/l/'
